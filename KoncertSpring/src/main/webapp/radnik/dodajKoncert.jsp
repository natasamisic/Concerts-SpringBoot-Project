...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div class="container">
		...
		<form:form action="/Koncert/worker/dodajKoncert" method="post" modelAttribute="koncert">
			<div class="form-group">
    			<label>Izvodjač:</label>
     			<form:input class="form-control" path="izvodjac"/>
 			 </div>
 			 <div class="form-group">
 			 	<label>Datum izvođenja:</label>
     			<form:input class="form-control" type="date" path="datumIzvodjenja"/>
 			 </div>
 			 <div class="form-group">
    			<label>Max broj karata::</label>
     			<form:input class="form-control" path="maxBrojKarata"/>
 			 </div>
 			 <div class="form-group">
    			<label>Trajanje:</label>
				<form:input class="form-control" path="trajanje"/>
 			 </div>
 			 <div class="form-group">
    			<label>Opis:</label>
 			 ...
 			 <div class="form-group">
    			<label>Grad:</label>
				<form:input class="form-control" path="grad"/>
 			 </div>
 			 <div class="form-group">
    			<label>Adresa:</label>
 			 ...
 			 <div class="form-group">
				...
				<form:input class="form-control" path="cena"/>
 			 </div>
 			 <div class="form-group">
    			<label>Žanr:</label>
				<form:select class="form-select" path="zanr" items="${zanrovi }" itemValue="idzanr" itemLabel="naziv"></form:select>
 			 </div>
