		...
		<c:if test="${!empty lista }">
			<table class="table table-bordered">
				...
				<c:forEach items="${lista }" var="k">
					...
					<td>${k.koncert.opis }</td>
					<td><form action="/Koncert/user/izbaciIzListeOmiljenih?idK=${k.idListaOmiljenihKoncerata}" method="post"><button class="btn" type="submit">Izbaci iz liste omiljenih</button></form></td>
				</tr>
				</c:forEach>
			</table>
		</c:if>
